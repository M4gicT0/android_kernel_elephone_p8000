...
#define CUST_EINT_HALL_COVER_NUM              8
#define CUST_EINT_HALL_COVER_DEBOUNCE_CN      0
#define CUST_EINT_HALL_COVER_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_HALL_COVER_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
